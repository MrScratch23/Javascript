...
// const radio = document.querySelector("txtRadio").value;
    ...
    // Presentamos el resultado al resultado al usuario
...
// 1- Recuperamos la division del resultado
const divResultado = document.querySelector("#divResultado");

// 2- Creamos la cadena de caracteres que se mostrara en la division

const solucion = "Una esfera de radio: " + radio + " tiene un volumen de: " + volumenEsfera + " unidades."

// 3- Mostramos la cadena de caracteres en la divison
